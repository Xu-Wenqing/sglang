...
class Qwen25Detector(BaseFormatDetector):
    """
    Detector for Intern-S1 model function call format.
    ...
    Reference: https://www.modelscope.cn/models/Shanghai_AI_Laboratory/Intern-S1/file/view/master/chat_template.jinja
    """
